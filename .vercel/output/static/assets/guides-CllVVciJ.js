var e=[{slug:`uae-job-search`,title:`UAE job search guide`,excerpt:`A working sequence for UAE applications: official channels, a CV matched to one job, an honest listing, and an offer you can read. HiredFrex is not a ministry.`,updated:`2026-09-19`,minutes:14,body:`This guide is for people targeting work in the United Arab Emirates using HiredFrex and official government channels. It is editorial information, not a recruitment contract and not legal advice. If a sentence here disagrees with MoHRE or u.ae, the government page wins.
...
Related: [International job scams](/blog/international-job-scams-red-flags), [Official UAE job channels](/blog/official-uae-job-channels), [How to check a UAE company name](/blog/how-to-check-a-uae-company-name).`},{slug:`uae-cv`,title:`UAE CV guide`,excerpt:`A one- and two-page structure for Gulf applications: visa line, truthful dates, and what not to attach. Use with the CV builder; do not invent jobs.`,updated:`2026-09-19`,minutes:12,related:[`/blog/uae-cv-format-what-recruiters-expect`],body:`Use this with the [CV builder](/cv-builder). The longer article, with examples of what not to include, is [UAE CV format: what recruiters expect](/blog/uae-cv-format-what-recruiters-expect). This page is the working template.
...
Related: [Entry-level jobs in the UAE](/blog/entry-level-jobs-in-the-uae), [Start here](/blog/start-here-gulf-job-search).`},{slug:`uae-interviews`,title:`UAE interview guide`,excerpt:`How to prepare for on-site, video, and high-volume screens for service and operations roles — and the questions that protect you after the meeting.`,updated:`2026-09-19`,minutes:12,body:`This is practical preparation, not a script that “beats” an employer’s process. A longer after-interview routine is in [What to do in the 24 hours after a Gulf interview](/blog/what-to-do-in-the-24-hours-after-a-gulf-interview).
...
Related: [WhatsApp job offers](/blog/whatsapp-job-offers), [Airport and hotel security jobs](/blog/airport-and-hotel-security-jobs-are-not-the-same).`},{slug:`uae-employment-visa`,title:`UAE employment visa guide`,excerpt:`Where official work-permit information lives, what a job board is not allowed to sell you, and how to spot a fake “MoHRE fee.”`,updated:`2026-09-19`,minutes:13,body:`HiredFrex does not issue visas. Anyone using our name to sell a “guaranteed UAE visa” is not us. This page exists so that sentence is public, dated, and linked from job pages.
...
Related: [UAE 2026 wage rules we can confirm](/blog/uae-2026-wage-rules-what-we-can-confirm), [Documents for overseas employment](/guides/overseas-employment-documents), [Official UAE job channels](/blog/official-uae-job-channels).`},{slug:`uae-security-jobs`,title:`UAE security jobs guide`,excerpt:`How to read security officer listings on HiredFrex: on-site work, missing salaries, site type, and documents employers often ask for later.`,updated:`2026-09-19`,minutes:12,body:`Security work in the UAE is on-site work: gates, patrols, hospitals, residential compounds, airports, hotels. HiredFrex will not label these roles remote. A longer comparison of airport and hotel posts is in [Airport and hotel security jobs are not the same](/blog/airport-and-hotel-security-jobs-are-not-the-same).
...
`},{slug:`uae-hospitality-jobs`,title:`UAE hospitality jobs guide`,excerpt:`Service-floor roles: why unsourced brand-name hotel listings were taken down, and how to read a remaining hospitality vacancy.`,updated:`2026-09-19`,minutes:11,body:`Housekeeping, front desk, waiter or waitress, and bell work is on-site. A listing that calls these remote fails HiredFrex review.
...
`},{slug:`verify-a-job-offer`,title:`How to verify a job offer`,excerpt:`A step-by-step check you should run even when the listing appeared on HiredFrex. Completeness review is not an offer letter.`,updated:`2026-09-19`,minutes:13,body:`A HiredFrex completeness review is not an offer letter. When someone sends you an offer, run this list. A document-level reading order is also in [How to read a UAE offer letter](/blog/how-to-read-a-uae-offer-letter).
...
`},{slug:`overseas-employment-documents`,title:`Documents needed for overseas employment`,excerpt:`What to prepare, what to withhold until the employer is real, and what HiredFrex will never ask for in a public form.`,updated:`2026-09-19`,minutes:12,body:`Requirements differ by country and occupation. This page is a packing list for you, not a government checklist. A narrative version is [Documents to prepare before overseas work](/blog/documents-to-prepare-before-overseas-work).
...
`},{slug:`ai-cv-screening`,title:`AI CV screening explained`,excerpt:`What automated screening usually does, how to write a CV that a human can still defend, and how HiredFrex does and does not use models.`,updated:`2026-09-19`,minutes:11,related:[`/blog/how-ai-cv-screening-works`],body:`The full desk piece is [How AI CV screening works](/blog/how-ai-cv-screening-works). This guide is the short operating manual: what to assume, what not to buy, and what HiredFrex’s own tools are allowed to do.
...
`},{slug:`ai-job-interviews`,title:`AI job interviews explained`,excerpt:`How to sit a structured video screen without buying a coaching package, and when a “proctor” is actually a scam.`,updated:`2026-09-19`,minutes:10,body:`Some employers use recorded questions for high-volume hiring. HiredFrex does not operate that product and does not have their scoring models. This page is setup, not a hack.
...
`},{slug:`responsible-hiring`,title:`Employer responsible hiring guide`,excerpt:`What HiredFrex expects from employers who post here, including copy we will reject, and how review labels actually work.`,updated:`2026-09-19`,minutes:11,body:`If you hire through HiredFrex you agree to post a real vacancy. Candidates never pay us to apply. You may not charge them either.
...
`}];function t(t){return e.find(e=>e.slug===t)??null}export{t as n,e as t};