...
//#region node_modules/.nitro/vite/services/ssr/assets/email-C1aFeNgz.js
function emailFromAddress() {
	return env("EMAIL_FROM") || `HiredFrex <support@hiredfrex.com>`;
}
...
<html><body style="font-family:Georgia,serif;background:#f7f3ea;padding:24px;color:#1b1915">
  <div style="max-width:520px;margin:0 auto;background:#fffdf8;border:1px solid #e4dccb;border-radius:18px;padding:28px">
    ...
    <h1 style="font-size:28px;margin:8px 0 12px;color:#10243f">${purpose === "reset" ? "Reset your HiredFrex password" : "Confirm your HiredFrex email"}</h1>
    <p style="line-height:1.5">${purpose === "reset" ? "Use this code to prove you own the inbox. It expires in 10 minutes." : "Enter this 6-digit code to finish email verification. It expires in 10 minutes."}</p>
